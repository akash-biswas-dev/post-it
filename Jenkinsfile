            ...
            parallel {
                stage('Build Client') {
                    steps{
                        ...
                        dir('client'){
                            sh 'docker build -t biswasakash/postit-client:docker-deployment .'
                        }
                    }
                }
                stage('Nginx Build') {
                    steps{
                        ...
                        dir('nginx'){
                            sh 'docker build -t biswasakash/postit-gateway:docker-deployment .'
                        }
                    }
                }
                stage('Server Build') {
                    steps{
                        ...
                        dir('server'){
                            sh 'docker build -t biswasakash/postit-server:docker-deployment .'
                        }
                    }
                }
            }
