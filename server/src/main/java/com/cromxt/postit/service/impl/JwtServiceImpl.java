...
public class JwtServiceImpl implements JwtService {
  ...
  public static class JwtConfigurer {
    ...
    public JwtConfigurer(String secret, String issuer) {
      this.secret = secret;
      this.issuer = issuer;
    ...
    public JwtConfigurer(String secret, Long expiration, String issuer) {
      this.secret = secret;
    ...
    public JwtConfigurer(String secret, Long expiration, Long refreshExpiration, String issuer) {
      this.secret = secret;
      this.expiration = expiration;
  ...
  public String generateToken(String userId, Collection<? extends GrantedAuthority> grantedAuthorities,
    ...
    if (Objects.isNull(extraPayload) || extraPayload.isEmpty()) {
      return buildToken(userId, extraClaims, jwtConfigurer.expiration);
    }
  ...
  public String generateToken(UserDetails userDetails, Map<String, Object> extraClaims) {
    ...
    return buildToken(userDetails.getUsername(), extraPayload, jwtConfigurer.expiration);
  }
  ...
  public String generateRefreshToken(String userId) {
    return buildToken(userId, new HashMap<>(), jwtConfigurer.refreshExpiration);
  }

  @Override
  public Long getRefreshTokenExpiration() {
    return jwtConfigurer.refreshExpiration;
  }
  ...
  public String generateSecret(String id) throws NoSuchAlgorithmException {
    ...
    String data = String.format("%s-%s-%s", id, jwtConfigurer.secret, System.currentTimeMillis());
  ...
  private Key getSignKey() {
    byte[] keyBytes = Decoders.BASE64.decode(jwtConfigurer.issuer);
  ...
  public String getIssuer() {
    return jwtConfigurer.issuer;
  }

  @Override
  public Long getExpiration() {
    return jwtConfigurer.expiration;
  }
